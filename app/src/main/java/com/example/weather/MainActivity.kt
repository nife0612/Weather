...
class MainActivity : AppCompatActivity() {
    ...
    val CITY_IP: String = "dhaka,bd"
    val API: String = "e7d80593b8dffcc013382645ace33bee"
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>() {
        ...
        override fun doInBackground(vararg p0: String?): String? {
            ...
            try {
                response =
                    URL("https://api.openweathermap.org/data/2.5/weather?q=$CITY_IP&units=metric&appid=$API").readText(
                        Charsets.UTF_8
                    )
            } catch (e: Exception) {
                response = null
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                findViewById<TextView>(R.id.llAddressContainer).text = address
...
class MainActivity : AppCompatActivity() {
    ...
    val CITY: String = "glazov,ru"
    val API: String = "e7d80593b8dffcc013382645ace33bee" // Use API key
